 ...
 *  EXPORT FUNCTION
 ******************************************************************************/
extern unsigned int get_hash_size(SEC_CRYPTO_HASH_TYPE hash);
extern unsigned int get_sigature_size(SEC_CRYPTO_SIGNATURE_TYPE sig);
