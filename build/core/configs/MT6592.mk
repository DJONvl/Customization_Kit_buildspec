...
CFLAGS += -DENABLE_UART4 -DCHIP_ID=\"MT6592\"
#CFLAGS += -DFPGA_FEATURE_ONLY
#CFLAGS += -DMT6582_FPGA_FEATURE_ONLY
CFLAGS += -DMT6592_USB_DELAY_SWITCH_SPEED
#CFLAGS += -DMT6592_USB_RG_RESET
#CFLAGS += -DMT6592_USB_RG_RESET_PHY_RST
#CFLAGS += -DUSB_PRETEND_HIGH_SPEED
#CFLAGS += -DUSB_UT
#CFLAGS += -DMT6592BRINGUP_DAHARDCODEEMI

$(if $(FLASH),$(eval CFLAGS += -D$(FLASH)),)
ifeq (yes,$(UT))
    CFLAGS += -DPLATFORM_TEST 
endif
CFLAGS += -DBB_$(BBCHIP) -DBB_MT6592
CFLAGS += -DBB_MT6582
