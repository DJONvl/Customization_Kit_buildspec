...
/*not in FPGA mode g_rx_buffer_baseaddr*/
#define FREE_INT_SYSRAM_BEGIN_ADDR	((uint32)0x82000000)
#define FREE_EXT_RAM_BEGIN_ADDR		((uint32)0x83000000)
#define EXT_RAM_BEGIN_ADDR			((uint32)0x84000000)
#define INT_SYSRAM_END_ADDR                   ((uint32)0x85000000) /*no use*/
...
//MT6580
#define EMI_CONA_MT6580		((volatile uint32 *)(EMI_BASE + 0x0000))
#define EMI_CONB_MT6580		((volatile uint32 *)(EMI_BASE + 0x0004))
#define EMI_CONC_MT6580		((volatile uint32 *)(EMI_BASE + 0x0008))
#define EMI_COND_MT6580		((volatile uint32 *)(EMI_BASE + 0x000C))
...
typedef struct
{
    ...
    unsigned int   DRAMC_ACTIM_VAL;        //@0x4000
    ...
    unsigned int   DRAMC_ACTIM05T_VAL;     //@0x41F8
    unsigned int   DRAMC_RKCFG_VAL;
    unsigned int   DRAMC_TEST2_4_VAL;    
