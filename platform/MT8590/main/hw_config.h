...
extern STATUS_E  	DetectExtSRAM(HW_RAMType_E *p_type, HW_ChipSelect_E *p_chip_select, uint32 *p_baseaddr, uint64 *p_size);
extern STATUS_E  	DetectExtDRAM(HW_RAMType_E *p_type, HW_ChipSelect_E *p_chip_select, uint32 *p_baseaddr, uint64 *p_size);
