...
#define	CONFIG_BASE				(0x10000000) //Sheet InfrasysAPB_AO, line 4
#define PERI_CON_BASE           (0x10002000) //Sheet InfrasysAPB_AO, line 6
#define DRAMC0_BASE             (0x10214000) //Sheet InfrasysAPB, line 35
#define GPIO_BASE               (0x10211000) //Sheet InfrasysAPB, line 32
#define WDT_BASE				(0x10212000) //Sheet InfrasysAPB, line 33, RGU includes WDT
#define	GPT_BASE				(0x10004000) //Sheet InfrasysAPB_AO, line 11
#define DDRPHY_BASE             (0x10213000) // sheet InfrasysAPB, line 34

#define	EMI_BASE			    (0x10203000) //Sheet InfrasysAPB, line 18
