...
#define MTK_WDT_MODE	RGU_BASE
#define MTK_WDT_MODE_DDR_RESERVE  	(0x0080)

#define MTK_WDT_MODE_KEY		(0x22000000)

#define MTK_WDT_DEBUG_CTL		(MTK_WDT_MODE+0x0040)
...
#define WRITE_REG(value, addr)	*(volatile unsigned int*)(addr) = (value)
...
typedef EMI_SETTINGS_v20 EMI_SETTINGS;
