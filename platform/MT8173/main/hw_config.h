...
//MT6595
#define EMI_CONA_MT8173		((volatile uint32 *)(EMI_BASE + 0x0000))
#define EMI_CONB_MT8173		((volatile uint32 *)(EMI_BASE + 0x0004))
#define EMI_CONC_MT8173		((volatile uint32 *)(EMI_BASE + 0x0008))
#define EMI_COND_MT8173		((volatile uint32 *)(EMI_BASE + 0x000C))
...
typedef struct {
	...
	uint8                                        m_nand_sub_device_code; //MLC, SLC, SPI
