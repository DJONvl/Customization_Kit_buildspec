...
const NAND_Device_S g_NandFlashDevTbl_Internal[] = {
    ...
    ,{ NAND_MT29C8G96MAZBADKD_5WT,  { { 0x2C, 0xB3, 0xD1, 0x55, 0x5A, 0xFF},   1024/*MB*/, 64, 2048, NAND_IO_16BITS, 5, 16 }, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL }
    ...
    ,{ NAND_TYBC0A111557KC, { { 0x98, 0xBC, 0x90, 0x66, 0x76, 0xFF},  512/*MB*/,  64,  4096, NAND_IO_16BITS, 5, 16},  &g_NAND_TOSHIBA_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL} 
    //------------------------------------------------------------------------------
    // HYNIX family flash
    //------------------------------------------------------------------------------
