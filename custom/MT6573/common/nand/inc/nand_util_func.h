...
#define NUTL_TOTAL_SIZE()								(g_pNandInfo->m_dev->m_hw_info.m_total_size_in_mb<<20)
...
#define	CB_NAND_READ_ID(t, maker, dev, ext1, ext2, ext3)		FP_CB_NAND_READ_ID()(t, maker, dev, ext1, ext2, ext3)   //modify by jiequn,2011.11.11
