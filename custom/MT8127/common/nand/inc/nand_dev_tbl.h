...
//8127 does not support TLC NAND.
//To align code with 8163 / 6580, we still use this define just to show 
//that 8127 NAND driver supports SLC mode operation on MLC NAND.
