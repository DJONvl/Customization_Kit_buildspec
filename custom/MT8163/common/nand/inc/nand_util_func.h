...
#define NUTL_DEVICE_TLC()                                                   (g_pNandInfo->m_dev->m_tlc_setting)
...
#define NUTL_2P_TLC()								(g_pNandInfo->m_dev->m_tlc_setting != NULL?g_pNandInfo->m_dev->m_tlc_setting->two_plane:FALSE)
