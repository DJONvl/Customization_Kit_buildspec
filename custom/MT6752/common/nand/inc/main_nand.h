...
extern void NMAIN_DownloadBLoader(void);
extern void NMAIN_DownloadImage(void);
extern void NMAIN_ReadCmd(void);
extern void NMAIN_Format(NUTL_EraseFlag_E  flag, uint32 start_addr, uint32 length, bool bValidation, NUTL_AddrTypeFlag_E addr_type);
