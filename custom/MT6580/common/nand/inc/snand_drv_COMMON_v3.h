...
*
*******************************************************************************/
#ifndef _SNAND_DRV_COMMON_V3_H_
#define _SNAND_DRV_COMMON_V3_H_
...
//------------------------------------------------------------------------------
extern const NAND_CMD_Callback_S	g_SNAND_COMMON_CB_FUNC_SET;
...
//------------------------------------------------------------------------------
STATUS_E SNAND_COMMON_PageSpareProgram_V3(uint32 row_addr,
...
//------------------------------------------------------------------------------
STATUS_E  SNAND_COMMON_CopyBack_V3(
				const uint32  c_timeout
				,const uint32  src_row_addr
				,const uint32  dest_row_addr);

STATUS_E  SNAND_COMMON_Randomizer_Config(
				bool use
				,uint32 pageNo);
