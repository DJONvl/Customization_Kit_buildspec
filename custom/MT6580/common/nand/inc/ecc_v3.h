...
#define ECC_ENCSTA      ((volatile uint32*)(ECC_base+0x00A0))
#define ECC_ENCIRQEN    ((volatile uint16*)(ECC_base+0x00A4))
#define ECC_ENCIRQSTA   ((volatile uint16*)(ECC_base+0x00A8))
#define ECC_PIO_DIRDY   ((volatile uint16*)(ECC_base+0x00AC))
#define ECC_PIO_DI      ((volatile uint32*)(ECC_base+0x00B0))
