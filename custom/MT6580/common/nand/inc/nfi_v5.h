...
#define NFI_RANDOM_CNFG_REG32 ((volatile uint32 *)(NFI_base+0x0238))
#define NFI_NAND_TYPE_CNFG_REG32 ((volatile uint32 *)(NFI_base+0x0240))
#define NFI_RANDOM_ENSEED01_TS_REG32 ((volatile uint32 *)(NFI_base+0x024C))
#define NFI_RANDOM_DESEED01_TS_REG32 ((volatile uint32 *)(NFI_base+0x0264))

#define NFI_MASTERSTA   ((volatile uint32 *)(NFI_base+0x0210))
#define NFI_SPIDMA      ((volatile uint32 *)(NFI_base+0x022C))

#define NFI_TLC_RD_WHR2 ((volatile uint32 *)(NFI_base+0x0300))
