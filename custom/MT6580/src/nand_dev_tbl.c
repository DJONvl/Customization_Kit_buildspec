...
//#if defined(__NFI_SUPPORT_TLC__)
    //8163 NEW
    { TNAND_SDTNRIAMA008GK,   { { 0x45, 0xDE, 0xA8, 0x92, 0x76, 0xFF, 0xFF},   (0xAC000000)/*B*/, 86, 16384, NAND_IO_8BITS, 5, 122,0 , 1024}, NAND_FLASH_TLC, &g_SANDISK_TLC_FEATURE, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL, NULL  }//SDTNRIAMA-008GK
    ...
    //8163 NEW
    ,{ TNAND_H27UDG8M2MTR,  { { 0xAD, 0xDE, 0x18, 0x03, 0x00, 0x40, 0xFF},   (0xB2000000)/*B*/, 128, 16384, NAND_IO_8BITS, 5, 128,0 , 1024}, NAND_FLASH_TLC, &g_HYNIX_TLC_FEATURE, &g_NAND_TOSHIBA_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL, NULL  }//TC58TEG6TCKTA00
    ,{ TNAND_TC58TEG6TGLTA00,  { { 0x98, 0xDE, 0x88, 0xA3, 0x72, 0xFF, 0xFF},   (0xB2800000)/*B*/, 128, 16384, NAND_IO_8BITS, 5, 122,0 , 1024}, NAND_FLASH_TLC, &g_TOSHIBA_TLC_FEATURE, &g_NAND_TOSHIBA_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL, NULL  }//TC58TEG6TCKTA00
    ,{ TNAND_TC58TEG7THL,      { { 0x98, 0x3A, 0x98, 0xA3, 0x76, 0x51, 0xFF},   (0x169800000/2)/*B*/, 128, 16384, NAND_IO_8BITS, 5, 122,0 , 1024}, NAND_FLASH_TLC, &g_TOSHIBA_TLC_FEATURE, &g_NAND_TOSHIBA_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, NULL, NULL, NULL  }//TC58TEG6TCKTA00
//#endif
...
//    ,{ NAND_MT29F128G08CBECB,	{ { 0x2C, 0x84, 0x64, 0x54, 0xA9, 0xFF, 0xFF},	 16384/*MB*/, 512, 16384, NAND_IO_8BITS, 5, 117,0 , 1024}, NAND_FLASH_MLC, NULL, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_MICRON_MLC_16NM_FEATURE, NULL, NULL  }
    ,{ NAND_SDTNRGAME_008G,   { { 0x45, 0xD7, 0x84, 0x93, 0x72, 0xFF, 0xFF},   4096/*MB*/, 256, 16384, NAND_IO_8BITS, 5, 80,0 , 1024}, NAND_FLASH_MLC, NULL, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_SANDISK_MLC_FEATURE, NULL, NULL  }
    ,{ NAND_SDTNRGAMA_008G,   { { 0x45, 0xDE, 0x94, 0x93, 0x76, 0xFF, 0xFF},   8192/*MB*/, 256, 16384, NAND_IO_8BITS, 5, 80,0 , 1024}, NAND_FLASH_MLC, NULL, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_SANDISK_MLC_FEATURE, NULL, NULL  }
	//Sandisk 1Znm
    ...
    ,{ NAND_TC58TEG5DCJTA00,   { { 0x98, 0xD7, 0x84, 0x93, 0x72, 0xFF, 0xFF},   4096/*MB*/, 256, 16384, NAND_IO_8BITS, 5, 80,0 , 1024}, NAND_FLASH_MLC, NULL, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_SANDISK_MLC_FEATURE, NULL, NULL  }
    ,{ NAND_H27UCG8T2ATR,   { { 0xAD, 0xDE, 0x94, 0xDA, 0x74, 0xFF, 0xFF},   4096/*MB*/, 256, 8192, NAND_IO_8BITS, 5, 80,0 , 1024}, NAND_FLASH_MLC, NULL, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_HYNIX_MLC_FEATURE, NULL, NULL  }
    ,{ NAND_H27UCG8T2ETR,   { { 0xAD, 0xDE, 0x14, 0xA7, 0x42, 0xFF, 0xFF},   8192/*MB*/, 256, 16384, NAND_IO_TOGGLE, 5, 100,0 , 1024}, NAND_FLASH_AMLC, &g_HYNIX_MLCTLC_FEATURE, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_HYNIX_16NM_MLC_FEATURE, NULL, NULL  }
    ,{ NAND_H27UCG4T2ETR,   { { 0xAD, 0xD7, 0x14, 0x9E, 0x34, 0xFF, 0xFF},   4096/*MB*/, 256, 8192, NAND_IO_TOGGLE, 5, 80,0 , 1024}, NAND_FLASH_AMLC, &g_HYNIX_MLCTLC_FEATURE, &g_NAND_SAMSUNG_2048_CMD_SET, &g_NAND_COMMON_CB_FUNC_SET, &g_HYNIX_16NM_MLC_FEATURE, NULL, NULL  }
	// Infineon: 512 page
