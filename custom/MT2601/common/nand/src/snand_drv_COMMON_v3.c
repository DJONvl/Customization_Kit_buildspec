...
#if defined(BB_MT6572)  || defined(BB_MT2601) // should be 72, use 71 for dev (fixme)
...
static void mtk_snand_ecc_config(u32 ecc_bit)
{
    ...
    #elif defined(BB_MT6572) || defined(BB_MT2601)
...
void mtk_snand_ecc_config_dynamic(u32 row_addr)
{
    ...
    #if defined(BB_MT6572) || defined(BB_MT2601)
    // do nothing
