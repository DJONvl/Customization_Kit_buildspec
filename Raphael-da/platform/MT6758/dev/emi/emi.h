...
#define HQA_VCORE_LV		760000 // uV
#define HQA_VCORE_NV		800000
#define HQA_VCORE_HV		840000

#define HQA_VCORE_KOPP0_LV	760000 //uV
#define HQA_VCORE_KOPP1_LV	710000
#define HQA_VCORE_KOPP2_LV	660000
#define HQA_VCORE_KOPP3_LV	660000

#define HQA_VCORE_KOPP0_NV	800000
#define HQA_VCORE_KOPP1_NV	750000
#define HQA_VCORE_KOPP2_NV	700000
#define HQA_VCORE_KOPP3_NV	700000

#define HQA_VCORE_KOPP0_HV	800000
#define HQA_VCORE_KOPP1_HV	770000
#define HQA_VCORE_KOPP2_HV	740000
#define HQA_VCORE_KOPP3_HV	740000

#if defined(HQA_LPDDR4X)
#define HQA_VDRAM_LV		1060000 //uV
#define HQA_VDRAM_NV		1125000
#define HQA_VDRAM_HV		1170000
#elif defined(HQA_LPDDR3)
#define HQA_VDRAM_LV		1160000 //uV
#define HQA_VDRAM_NV		1220000
#define HQA_VDRAM_HV		1300000
#endif

#define HQA_VDDQ_LV		570000 //uV
#define HQA_VDDQ_NV		600000
#define HQA_VDDQ_HV		650000
