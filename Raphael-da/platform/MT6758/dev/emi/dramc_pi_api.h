...
#define CLOCK_DUTY_SCAN_APPLY_RK0_TO_RK1    1   // 0: for debug
...
#define ENABLE_RODT_TRACKING_SAVE_1UI 0 //Maybe turn on behind Vinson project
...
#define XRTW2W_PerformanceEnhance_Tx_DVT
#if (defined(HW_GATING) && ENABLE_RX_TRACKING_LP4)
#define XRTR2R_PerformanceEnhance_DQSG_TRACK_RX_DLY_DVT
#endif
//#define XRTR2W_PerformanceEnhance_RODTEN_DVT    //conflict with ENABLE_RODT_TRACKING, LP4 support only
...
/* LP4 PI cross-latch for duty improvement (LP4 > DDR1866) */
#define PI_DUTY_IMPROVEMENT 1 //Named PI_DUTY_IMPROVEMENT_TEST in Bianco
...
#undef XRTW2W_PerformanceEnhance_Tx_DVT
#undef XRTR2R_PerformanceEnhance_DQSG_TRACK_RX_DLY_DVT
#ifdef XRTR2W_PerformanceEnhance_RODTEN_DVT
#undef XRTR2W_PerformanceEnhance_RODTEN_DVT     //conflict with ENABLE_RODT_TRACKING, LP4 support only
#endif
...
{
    U16 u2MR5VendorID;
    U32 u4MR8Density[CHANNEL_NUM][RANK_MAX];
} DRAM_INFO_BY_MRR_T;
#endif
...
void CKEFixOnOff(DRAMC_CTX_T * p,U8 option);
