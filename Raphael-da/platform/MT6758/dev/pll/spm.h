...
#define __raw_writeb(reg, val)  (*(volatile unsigned char * const)(reg)) = (val)
#define __raw_readw(reg)		(*(volatile unsigned short * const)(reg))
#define __raw_writew(reg, val)  (*(volatile unsigned short * const)(reg)) = (val)
#define __raw_readl(reg)		(*(volatile unsigned int * const)(reg))
#define __raw_writel(reg, val)  (*(volatile unsigned int * const)(reg)) = (val)
