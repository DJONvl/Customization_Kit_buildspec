...
#endif
#define I2CLOG(fmt, arg...)   LOGD(I2CTAG fmt, ##arg)
#define I2CMSG(fmt, arg...)   LOGD(fmt, ##arg)
#define I2CERR(fmt, arg...)   LOGD(I2CTAG "%d: "fmt, __LINE__, ##arg)
#define I2CFUC(fmt, arg...)   LOGD(I2CTAG "%s\n", __FUNCTION__)
...
//#define I2C_DRIVER_IN_KERNEL
  ...
  #else
    #define I2C_CLK_RATE		62500 /* using univpll3_d8 fixed clock source */
    #define I2C_CLK_DIV		(2*5) /* frequency divisor */
...
#define PERI_I2C_MODE_ENABLE 	(PERICFG_BASE + 0x68)
#define PERI_I2C_CLK_SEL 		(TOPCKGEN_BASE + 0x130)
#define I2C_CLK_SEL_OFST	(16)
