...
/*--------------------------------------------------------------------------*/
//for elbrus
#define MSDC0_GPIO_SMT_ADDR			(IO_BR_BASE + 0x100)
#define MSDC0_GPIO_IES_ADDR			(IO_BR_BASE + 0x000)
#define MSDC0_GPIO_PUPD0_ADDR		(IO_BR_BASE + 0x700)
#define MSDC0_GPIO_PUPD1_ADDR		(IO_BR_BASE + 0x710)
#define MSDC0_GPIO_DRV_ADDR			(IO_BR_BASE + 0x600)
#define MSDC0_GPIO_MODE15_ADDR		(GPIO_BASE   + 0x440)
#define MSDC0_GPIO_MODE16_ADDR		(GPIO_BASE   + 0x450)
#define MSDC0_GPIO_TDSEL_ADDR       (IO_BR_BASE + 0x200)
#define MSDC0_GPIO_RDSEL_ADDR       (IO_BR_BASE + 0x300)

#define MSDC1_GPIO_SMT_ADDR			(IO_TR_BASE + 0x100)
#define MSDC1_GPIO_IES_ADDR			(IO_TR_BASE + 0x0)
#define MSDC1_GPIO_PUPD0_ADDR		(IO_TR_BASE + 0x700)
#define MSDC1_GPIO_PUPD1_ADDR		(IO_TR_BASE + 0x710)
#define MSDC1_GPIO_DRV_ADDR			(IO_TR_BASE + 0x600)
#define MSDC1_GPIO_MODEF_ADDR		(GPIO_BASE   + 0x3E0)
#define MSDC1_GPIO_TDSEL_ADDR       (IO_TR_BASE + 0x200)
#define MSDC1_GPIO_RDSEL_ADDR       (IO_TR_BASE + 0x300)
