...
#define IMGPLL_CON0            (APMIXED_BASE + 0x260)
#define IMGPLL_CON1            (APMIXED_BASE + 0x264)
#define IMGPLL_PWR_CON0        (APMIXED_BASE + 0x26C)
...
#define CODECPLL_CON1          (APMIXED_BASE + 0x294)
...
#define VDECPLL_CON1              (APMIXED_BASE + 0x2E8)
#define VDECPLL_CON2              (APMIXED_BASE + 0x2EC)
