...
// UART Register                                                                
//------------------------------------------------------------------------------
#define UART_RBR		    (base+0x0000)		/* Read only */
#define UART_THR		    (base+0x0000)		/* Write only */
#define UART_IER		    (base+0x0004)
#define UART_IIR		    (base+0x0008)		/* Read only */
#define UART_FCR		    (base+0x0008)		/* Write only */
#define UART_LCR		    (base+0x000c)
#define UART_MCR		    (base+0x0010)
#define UART_LSR		    (base+0x0014)
#define UART_MSR		    (base+0x0018)
#define UART_SCR		    (base+0x001c)
#define UART_DLL		    (base+0x0000)
#define UART_DLH		    (base+0x0004)
#define UART_EFR		    (base+0x0008)		/* Only when LCR = 0xbf */
#define UART_XON1	        (base+0x0010)		/* Only when LCR = 0xbf */
#define UART_XON2	        (base+0x0014)		/* Only when LCR = 0xbf */
#define UART_XOFF1	        (base+0x0018)		/* Only when LCR = 0xbf */
#define UART_XOFF2	        (base+0x001c)		/* Only when LCR = 0xbf */
#define UART_HIGHSPEED      (base+0x0024)
#define UART_SAMPLE_COUNT   (base+0x0028)
#define UART_SAMPLE_POINT   (base+0x002C)
