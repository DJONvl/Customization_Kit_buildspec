...
#define CLK_CFG_UPDATE_PLL   (CKSYS_BASE + 0x004)
...
#define CLK_CFG_0_PLL      (CKSYS_BASE + 0x040)
...
//need fixed miya 
//#define INFRA_PDN_CLR2          (INFRACFG_AO_BASE + 0x00AC)
/* Audio Register*/
...
extern unsigned int mt_get_mem_freq(void);
