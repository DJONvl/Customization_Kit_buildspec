...
#else
#define         EMI_CONC                (( P_U32)EMI_APB_BASE + 0xc)
#endif
...
#define         EMI_CONI                 (( P_U32)(EMI_BASE+0x040))              /* Data transfer overhead for specific non-32bytes alignment write data size */
#define         EMI_CONM                (( P_U32)(EMI_BASE+0x060))              /* MISC */
#define         EMI_MDCT		         (( P_U32)(EMI_BASE + 0x78))
#define         EMI_TEST0               (( P_U32)(EMI_BASE+0x0D0))              /* Test mode 0. */
#define         EMI_TEST1               (( P_U32)(EMI_BASE+0x0D8))              /* Test mode 1. */
