...
#define SEGMENT_CODE    (*(volatile unsigned int *)0x1020627C)&0xFF

//1: Jade minus, 0: Jade
#define JADE_MINUS_S    SEGMENT_CODE&0x40

#define JADE_ROSA_S    ((*(volatile unsigned int *)0x1020627C)&0x8000)

#define JADE_OR_MINUS    (chip_segment_mapping())

#define PWRAPTAG                "[PWRAP] "
#ifdef PMIC_WRAP_DEBUG
#define PWRAPDEB(fmt, arg...)   LOGD(PWRAPTAG fmt,##arg)
#define PWRAPFUC(fmt, arg...)   LOGD(PWRAPTAG "%s\n", __FUNCTION__)
#define PWRAPLOG(fmt, arg...)   LOGD(PWRAPTAG fmt,##arg)
#define PWRAPERR(fmt, arg...)   LOGD(PWRAPTAG "ERROR,line=%d " fmt, __LINE__, ##arg)
#define PWRAPREG(fmt, arg...)   LOGD(PWRAPTAG fmt,##arg)
#else
...
//---start ---external API--------------------------------------------------
S32 pwrap_read_6353( U32  adr, U32 *rdata );
S32 pwrap_write_6353( U32  adr, U32  wdata );
S32 pwrap_read_6351( U32  adr, U32 *rdata );
S32 pwrap_write_6351( U32  adr, U32  wdata );
...
//S32 pwrap_init ( void );
S32 pwrap_init_DA_6351( void );
S32 pwrap_init_DA_6353( void );
