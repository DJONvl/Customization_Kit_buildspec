...
#endif
#define LAST_DRAM_FATAL_ERR_FLAG	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE)
#define DRAM_FATAL_ERR_FLAG		(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 4)
#define STORAGE_API_ERR_FLAG		(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 8)
#define LAST_DRAM_GATING_ERR_CHA_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 12)
#define LAST_DRAM_GATING_ERR_CHA_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 16)
#define LAST_DRAM_GATING_ERR_CHB_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 20)
#define LAST_DRAM_GATING_ERR_CHB_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 24)
#define LAST_DRAM_GATING_ERR_CHC_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 28)
#define LAST_DRAM_GATING_ERR_CHC_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 32)
#define LAST_DRAM_GATING_ERR_CHD_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 36)
#define LAST_DRAM_GATING_ERR_CHD_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 40)
#define DRAM_GATING_ERR_CHA_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 44)
#define DRAM_GATING_ERR_CHA_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 48)
#define DRAM_GATING_ERR_CHB_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 52)
#define DRAM_GATING_ERR_CHB_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 56)
#define DRAM_GATING_ERR_CHC_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 60)
#define DRAM_GATING_ERR_CHC_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 64)
#define DRAM_GATING_ERR_CHD_RK0	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 68)
#define DRAM_GATING_ERR_CHD_RK1	(DRAM_DEBUG_SRAM_BASE + LAST_DRAMC_SRAM_SIZE + 72)
...
#ifdef LAST_LPDMA
int update_last_lpdma_info(void);
typedef struct {
    unsigned int last_lpdma_cona;
    unsigned int last_lpdma_conb;
    unsigned int last_lpdma_conc;
    unsigned int last_lpdma_cond;
    unsigned int last_lpdma_cone;
    unsigned int last_lpdma_conr;
    unsigned int last_lpdma_conh;
    unsigned int last_lpdma_coni;
    unsigned int last_lpdma_conj;
    unsigned int last_lpdma_conm;
    unsigned int last_lpdma_conq;
    unsigned int last_lpdma_intlv;
    unsigned int last_lpdma_casd;
    unsigned int last_lpdma_mask;
    unsigned int last_lpdma_sta;
    unsigned int last_lpdma_dbg830;
    unsigned int last_lpdma_dbg838;
    unsigned int last_lpdma_dbg840;	
    unsigned int last_lpdma_dbg890;
    unsigned int last_lpdma_dbg898;
    unsigned int last_lpdma_dbg8a0;
    unsigned int last_lpdma_dbg8a8;
    unsigned int last_lpdma_dbg8b0;
    unsigned int last_lpdma_dbg8b8;
    unsigned int last_lpdma_dbg8c0;
    unsigned int last_lpdma_dbg8c8;	
    unsigned int last_emi_lpct1;	
} LAST_LPDMA_INFO_T;
#if !__ETT__
#define DEF_LAST_LPDMA LAST_LPDMA_INFO_T
#endif /*LAST_LPDMA*/
#endif
//================================================
...
#define HQA_VCORE_LV 850000 // uV
#define HQA_VCORE_NV 900000
#define HQA_VCORE_HV 950000

#define HQA_VCORE_KLV_OPP0 850000 //uV
#define HQA_VCORE_KLV_OPP1 850000
#define HQA_VCORE_KLV_OPP2 760000
#define HQA_VCORE_KLV_OPP3 760000
#define HQA_VCORE_KNV_OPP0 900000
#define HQA_VCORE_KNV_OPP1 900000
#define HQA_VCORE_KNV_OPP2 800000
#define HQA_VCORE_KNV_OPP3 800000
#define HQA_VCORE_KHV_OPP0 950000
#define HQA_VCORE_KHV_OPP1 950000
#define HQA_VCORE_KHV_OPP2 840000
#define HQA_VCORE_KHV_OPP3 840000

#define VDRAM_LV 1060000 //uV
#define VDRAM_NV 1100000
#define VDRAM_HV 1170000

#define VDDQ_LV 570000 //uV
#define VDDQ_NV 600000
#define VDDQ_HV 630000
