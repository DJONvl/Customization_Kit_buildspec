...
#else
#define CHANNEL_NUMBER      1   // 1 single channek, 2 dual channel, 4 4 channel
#endif
...
// enable calibration result for preloader
...
#undef SET_CKE_2_RANK_INDEPENDENT_RUN_TIME 
#define SET_CKE_2_RANK_INDEPENDENT_RUN_TIME 1
...
#undef CLK_FREE_FUN_FOR_DRAMC_PSEL
...
//       U8 u1RxWinPerbitDQM_bypass_Save[CHANNEL_MAX][RANK_MAX][PLL_FREQ_SEL_MAX][DQS_NUMBER];  //for bypass rxwindow
    ...
    u8 u1TX_PerBit_DelayLine_Save[CHANNEL_MAX][RANK_MAX][DRAM_DFS_SHUFFLE_MAX][DQS_BIT_NUMBER];  
...
//3733,3200,2667,2400,1600,1333,800
