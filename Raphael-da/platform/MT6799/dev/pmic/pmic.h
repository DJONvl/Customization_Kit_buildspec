...
extern unsigned int pmic_upmu_set_baton_tdet_en(unsigned int val);
extern unsigned int pmic_upmu_set_rg_baton_en(unsigned int val);
extern unsigned int pmic_upmu_get_rgs_baton_undet(void);
