...
typedef enum {
   MSDC_CLKSRC_DEFAULT = 0,       /* MSDC owner request clock owner to configure clock source to desired one,
                                   * and he can define MSDC_CLKSRC_DEFAULT as any value
                                   */
} clk_source_t;

//E1
#define MSDC_CLKSRC_HZ	    (728000000/2)
//E2
//#define MSDC_CLKSRC_HZ	  (800000000/2)
