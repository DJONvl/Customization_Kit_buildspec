...
#define SDC_STS_DVFS_LEVEL              (0xf  << 27)    /* RU */
...
/* SDC_ADV_CFG0 mask */
#define SDC_ADV_CFG0_CMD_RESP_CRC       (0x7f << 0)     /* RU */
#define SDC_ADV_CFG0_CMD_RESP_INDEX     (0x3f << 7)     /* RU */
#define SDC_ADV_CFG0_CMD_RESP_ENDBIT    (0x1 << 13)     /* RU */
#define SDC_ADV_CFG0_CMD_ENDBIT_CHECK   (0x1 << 14)     /* RW */
#define SDC_ADV_CFG0_CMD_INDEX_CHECK    (0x1 << 15)     /* RW */
#define SDC_ADV_CFG0_DAT_BUFF_CLK_DIV   (0x3 << 16)     /* RW */
#define SDC_ADV_CFG0_DAT_BUFF_FREQ_CTRL_EN (0x3 << 18)     /* RW */
#define SDC_ADV_CFG0_SRC_RX_ENHANCE_EN  (0x3 << 20)     /* RW */
...
#define MSDC_HW_DBG_WRAP_SEL            (0x1UL<< 31)
...
#define MTKCQ_CFG2_CMD_FREE_W_EM        (0x1 << 5)
...
#define MTKCQ_TASK_DONE_ST_EMMC52_R1_ERR_EN     (0x1 << 7)      /* RW */
...
#define MTKCQ_ERR_ST_CLR_OTHER_CMD_RESP_TO_CLR          (0x1 << 13)     /* W1 */
#define MTKCQ_ERR_ST_CLR_CQ_R1_RESP_ERR_CLR             (0x1 << 17)     /* W1 */
#define MTKCQ_ERR_ST_CLR_EMMC52_R1_ERR_CLR              (0x1 << 18)     /* W1 */
 ...
 *MSDC TOP REG
 */
#define REG_ADDR_TOP(x)                 ((volatile u32*)(MSDC_TOP_BASE + OFFSET_##x))
