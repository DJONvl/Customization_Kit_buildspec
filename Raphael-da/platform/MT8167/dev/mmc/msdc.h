...
*/
#define IO_CONFIG_BASE           (0x10005000)

#define REG1_ADDR(x)        ((volatile u32*)(GPIO_BASE + x))
#define REG2_ADDR(x)        ((volatile u32*)(IO_CONFIG_BASE + x))

#define MSDC_GPIO_MODE17             REG1_ADDR(0x460)
#define MSDC0_DAT7_GPIO       (0x7 << 0)
#define MSDC0_DAT6_GPIO       (0x7 << 3)
#define MSDC0_DAT5_GPIO       (0x7 << 6)
#define MSDC0_DAT4_GPIO       (0x7 << 9)
#define MSDC0_RST_GPIO       (0x7 << 12)
#define MSDC0_GPIO17_ALL_MASK       (0x7FFF)

#define MSDC_GPIO_MODE18             REG1_ADDR(0x470)
#define MSDC0_CMD_GPIO       (0x7 << 0)
#define MSDC0_CLK_GPIO       (0x7 << 3)
#define MSDC0_DAT3_GPIO       (0x7 << 6)
#define MSDC0_DAT2_GPIO       (0x7 << 9)
#define MSDC0_DAT1_GPIO       (0x7 << 12)
#define MSDC0_GPIO18_ALL_MASK       (0x7FFF)

#define MSDC_GPIO_MODE19             REG1_ADDR(0x480)
#define MSDC0_DAT0_GPIO       (0x7 << 0)

#define MSDC0_PUPD0_CTRL_BASE     REG2_ADDR(0xE00)
#define MSDC0_DAT0_PUPD       (0xF << 0)
#define MSDC0_DAT1_PUPD       (0xF << 4)
#define MSDC0_DAT2_PUPD       (0xF << 8)
#define MSDC0_DAT3_PUPD       (0xF << 12)
#define MSDC0_DAT1_3_PUPD   (0xFFFF)


#define MSDC0_PUPD1_CTRL_BASE     REG2_ADDR(0xE10)
#define MSDC0_DAT4_PUPD       (0xF << 0)
#define MSDC0_DAT5_PUPD       (0xF << 4)
#define MSDC0_DAT6_PUPD       (0xF << 8)
#define MSDC0_DAT7_PUPD       (0xF << 12)
#define MSDC0_DAT4_7_PUPD   (0xFFFF)

#define MSDC0_PUPD2_CTRL_BASE     REG2_ADDR(0xE20)
#define MSDC0_CMD_PUPD       (0xF << 0)
#define MSDC0_CLK_PUPD       (0xF << 4)
#define MSDC0_RST_PUPD       (0xF << 8)

#define MSDC0_RDSEL0_BASE            REG2_ADDR(0xC60)
#define MSDC0_CLK_RDSEL          (0x3F << 0 )     /* RW */
#define MSDC0_CMD_RDSEL          (0x3F << 6 )     /* RW */

#define MSDC0_RDSEL1_BASE            REG2_ADDR(0xC70)
#define MSDC0_DAT_RDSEL          (0x3F << 0 )     /* RW */
#define MSDC0_RST_RDSEL          (0x3F << 6 )     /* RW */

#define MSDC0_TDSEL0_BASE            REG2_ADDR(0xB60)
#define MSDC0_CLK_TDSEL          (0xF << 12 )     /* RW */
#define MSDC0_CMD_TDSEL          (0xF << 8 )     /* RW */

#define MSDC0_TDSEL1_BASE            REG2_ADDR(0xB70)
#define MSDC0_DAT_TDSEL          (0xF << 0 )     /* RW */
#define MSDC0_RST_TDSEL          (0xF << 4)     /* RW */

#define MSDC0_SMT_BASE       REG2_ADDR(0xA20)
#define MSDC0_SMT_ALL_MASK      0x7FF

#define MSDC0_DRVING0_BASE          REG2_ADDR(0xD60)
#define MSDC0_CMD_DRVING            (0xF << 8)     /* RW */
#define MSDC0_CLK_DRVING            (0x7 << 12)     /* RW */

#define MSDC0_DRVING1_BASE          REG2_ADDR(0xD70)
#define MSDC0_DAT_DRVING           (0xF <<  0)     /* RW */
#define MSDC0_RST_DRVING            (0xF << 4)     /* RW */
/*--------------------------------------------------------------------------*/
