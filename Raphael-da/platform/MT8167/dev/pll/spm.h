...
#define SPM_IRQ0_ID		SPM_IRQ_BIT0_ID
#define SPM_IRQ1_ID		SPM_IRQ_BIT1_ID
#define SPM_IRQ2_ID		SPM_IRQ_BIT2_ID
#define SPM_IRQ3_ID		SPM_IRQ_BIT3_ID
#define SPM_IRQ4_ID		SPM_IRQ_BIT4_ID
#define SPM_IRQ5_ID		SPM_IRQ_BIT5_ID
#define SPM_IRQ6_ID		SPM_IRQ_BIT6_ID
#define SPM_IRQ7_ID		SPM_IRQ_BIT7_ID
...
#define SPM_ARMPLL_DIV_PWR_CON  (SPM_BASE + 0x2cc)//Rainier, not in CODA
#define SPM_MD2_PWR_CON         (SPM_BASE + 0x2d0)//Rainier, not in CODA
#define SPM_C2K_PWR_CON         (SPM_BASE + 0x2d4)//mt6735//Rainier, not in CODA
#define SPM_INFRA_MD_PWR_CON    (SPM_BASE + 0x2d8)//mt6735//Rainier, not in CODA
...
#define SPM_RF_CLK_CFG		        (SPM_BASE + 0x620)//mt6580, add for Rainier
#define SPM_RF_CFG_SET		      (SPM_BASE + 0x624)//mt6580, add for Rainier
#define SPM_RF_CLK_CFG_CLR		    (SPM_BASE + 0x628)//mt6580, add for Rainier
#define SPM_BSI_DO_SR		      (SPM_BASE + 0x62c)//mt6735//Rainier, not in CODA
#define SPM_BSI_D1_SR		      (SPM_BASE + 0x630)//mt6735//Rainier, not in CODA
#define SPM_BSI_D2_SR		      (SPM_BASE + 0x634)//mt6735//Rainier, not in CODA
#define SPM_AP_SEMA		        (SPM_BASE + 0x638)//mt6735//Rainier, not in CODA
#define SPM_SPM_SEMA		      (SPM_BASE + 0x63c)//mt6735//Rainier, not in CODA
...
#define SPM_SLEEP_IDLE_SEL      	(SPM_BASE + 0x78C)//Rainier, not in CODA
...
#define SPM_PCM_RESERVE3		(SPM_BASE + 0xb14)//Rainier, not in CODA
#define SPM_PCM_RESERVE4		(SPM_BASE + 0xb18)//Rainier, not in CODA //TODO: check if used
#define SPM_PCM_DEBUG_CON		(SPM_BASE + 0xb20)
#define SPM_PCM_WDT_LATCH     (SPM_BASE+0xb24) //mt6580, add for Rainier
...
#define SPM_INFRA_PDM_26M_WAKE		  (1U << 6)//TODO: check with Hank //mt6580, add for Rainier : Disable SODI
#define SPM_INFRA_MD_PDN_DIS	 (1U << 7)//TODO: check with Hank //mt6580, add for Rainier : MEMPLL 0:shutdown mode 1:reset mode
//#define SPM_MAINPLL_PDN_DIS	  (1U << 8)//mt6580, add for Rainier : 
#define SPM_CPU_DVS_DIS		(1U << 9)
//#define SPM_CPU_DORMANT		  (1U << 10)//mt6580, add for Rainier : 
//#define SPM_EXT_VSEL_GPIO103    (1U << 11)//TODO: check with Hank //mt6580, add for Rainier : 
//#define SPM_DDR_HIGH_SPEED	      (1U << 12)//mt6580, add for Rainier : 
//#define SPM_DISABLE_ATF_ABORT     (1U << 13)//Rainier, not use
//#define SPM_MEMPLL_1PLL_3PLL_SEL  (1U << 16) //Rainier, not use
//#define SPM_VCORE_DVS_POSITION	  (1U << 17) //Rainier, not use
#define SPM_BYPASS_DPYCFG_CG (1U << 18)
//#define SPM_BUCK_SEL				(1U << 18) //Rainier, not use
//#define SPM_DRAM_RANK1_ADDR_SEL0	(1U << 19)//0x60000000 //Rainier, not use
//#define SPM_DRAM_RANK1_ADDR_SEL1	(1U << 20)//0x80000000 //Rainier, not use
//#define SPM_DRAM_RANK1_ADDR_SEL2	(1U << 21)//0xc0000000 //Rainier, not use
#endif
/* Wakeup Source*/
#if 1
#define SPM_WAKE_SRC_LIST	{	\
	SPM_WAKE_SRC(0, SPM_MERGE),	/* PCM timer, TWAM or CPU */	\
	SPM_WAKE_SRC(1, AUDIO_REQ), /* mt6580 */	\
	SPM_WAKE_SRC(2, KP),		\
	SPM_WAKE_SRC(3, WDT),		\
	SPM_WAKE_SRC(4, GPT),		\
	SPM_WAKE_SRC(5, EINT),	\
	SPM_WAKE_SRC(6, CONN_WDT),		\
	SPM_WAKE_SRC(7, GCE), /* mt6580,add for Rainier */	\
	SPM_WAKE_SRC(8, CCIF0_MD),	/* mt6580,add for Rainier */ \
	...
	SPM_WAKE_SRC(16, MD1_VRF18_WAKE),	/* mt6580,add for Rainier */ \
	SPM_WAKE_SRC(17, MD1_VRF18_SLEEP), /* mt6580,add for Rainier */ \
	SPM_WAKE_SRC(18, DBGSYS), /* mt6580,add for Rainier */	\
	SPM_WAKE_SRC(19, UART0),	\
	SPM_WAKE_SRC(20, AFE),		\
	SPM_WAKE_SRC(21, THERM),	\
	SPM_WAKE_SRC(22, CIRQ),		\
	SPM_WAKE_SRC(23, SEJ), /* mt6580,add for Rainier */	\
	SPM_WAKE_SRC(24, SYSPWREQ),	\
	SPM_WAKE_SRC(25, MD1_WDT),	/* mt6580,add for Rainier */ \
	SPM_WAKE_SRC(26, CPU0_IRQ),	/* mt6580,add for Rainier */ \
	SPM_WAKE_SRC(27, CPU1_IRQ),	/* mt6580,add for Rainier */	\
	SPM_WAKE_SRC(28, CPU2_IRQ),	/* mt6580,add for Rainier */ \
	SPM_WAKE_SRC(29, CPU3_IRQ),	/* mt6580,add for Rainier */ \
