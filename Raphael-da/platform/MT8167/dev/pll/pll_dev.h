...
#define LVDSPLL_CON0		(APMIXED_BASE + 0x01E0)
#define LVDSPLL_CON1		(APMIXED_BASE + 0x01E4)
#define LVDSPLL_PWR_CON0	(APMIXED_BASE + 0x01F0)
...
#define SET_CLK_GATING_CTRL8	(CKSYS_BASE + 0x0A0)
#define SET_CLK_GATING_CTRL9	(CKSYS_BASE + 0x0A4)
#define CLR_CLK_GATING_CTRL8	(CKSYS_BASE + 0x0B0)
...
/* VDEC Register       */
/***********************/
#define VDEC_CKEN_SET		(VDEC_BASE + 0x0)
#define VDEC_CKEN_CLR		(VDEC_BASE + 0x4)
#define VDEC_LARB1_CKEN_SET	(VDEC_BASE + 0x8)
#define VDEC_LARB1_CKEN_CLR	(VDEC_BASE + 0xC)
...
//====================================================
//dram clock come from mempll
//#define MEMPLL_CLK_533		//DDR-1066
//#define MEMPLL_CLK_667		//DDR-1333
#define MEMPLL_CLK_800		//DDR-1600

//====================================================

void mt_pll_init();
void mt_pll_post_init(void);
uint32 SAL_Query_UART_Clock(void);
