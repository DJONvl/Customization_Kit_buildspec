...
#define FQMTR_FIX_CLK_26M							((0 << MT6392_PMIC_RG_FQMTR_CKSEL_SHIFT) | ~(MT6392_PMIC_RG_FQMTR_CKSEL_MASK << MT6392_PMIC_RG_FQMTR_CKSEL_SHIFT))
#define FQMTR_FIX_CLK_XOSC_32K_DET		(2 << MT6392_PMIC_RG_FQMTR_CKSEL_SHIFT)
#define FQMTR_FIX_CLK_EOSC_32K				(3 << MT6392_PMIC_RG_FQMTR_CKSEL_SHIFT)
