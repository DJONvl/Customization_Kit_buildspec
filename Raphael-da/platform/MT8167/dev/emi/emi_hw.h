...
#define         EMI_CONI                (( P_U32)(EMI_BASE+0x060))              /* ISP Configuration */
#define         EMI_CONJ                (( P_U32)(EMI_BASE+0x060))              /* ISP Configuration 1 */
#define         EMI_CONK                (( P_U32)(EMI_BASE+0x060))              /* ISP Configuration 2 */
#define         EMI_CONM                (( P_U32)(EMI_BASE+0x060))              /* MISC */
#define         EMI_MDCT                (( P_U32)(EMI_BASE+0x078))              /* MODEN CONTROL */
#define         EMI_TEST0               (( P_U32)(EMI_BASE+0x0D0))              /* Test mode 0. */
#define         EMI_TEST1               (( P_U32)(EMI_BASE+0x0D8))              /* Test mode 1. */
#define         EMI_TESTA               (( P_U32)(EMI_BASE+0x0E0))              /* Test mode A. */
...
#define         EMI_ARBB                (( P_U32)(EMI_BASE+0x108))              /* EMI bandwidth filter control MM */
#define         EMI_ARBC                (( P_U32)(EMI_BASE+0x110))              /* EMI bandwidth filter control PeriSYS */
#define         EMI_ARBD                (( P_U32)(EMI_BASE+0x118))              /* Not used in 8167: MDMCU */
#define         EMI_ARBE                (( P_U32)(EMI_BASE+0x120))              /* Not used in 8167: Modem Hardware */
#define         EMI_ARBF                (( P_U32)(EMI_BASE+0x128))              /* EMI bandwidth filter control MFGSYS */
#define         EMI_ARBG                (( P_U32)(EMI_BASE+0x130))              /* EMI bandwidth filter control CONNSYS */
...
#define         EMI_BSTP                (( P_U32)(EMI_BASE+0x404))              /* EMI bus monitor auto stop counter */
...
#define         EMI_BMID0               (( P_U32)(EMI_BASE+0x4B0))              /* EMI ID selection for 1-2 transaction type counters */
#define         EMI_BMID1               (( P_U32)(EMI_BASE+0x4B4))              /* EMI ID selection for 3-4 transaction type counters */
#define         EMI_BMID2               (( P_U32)(EMI_BASE+0x4B8))              /* EMI ID selection for 5-6 transaction type counters */
#define         EMI_BMID3               (( P_U32)(EMI_BASE+0x4BC))              /* EMI ID selection for 7-8 transaction type counters */
#define         EMI_BMID4               (( P_U32)(EMI_BASE+0x4C0))              /* EMI ID selection for 9-10 transaction type counters */
#define         EMI_BMID5               (( P_U32)(EMI_BASE+0x4C4))              /* EMI ID selection for 11-12 transaction type counters */
#define         EMI_BMID6               (( P_U32)(EMI_BASE+0x4C8))              /* EMI ID selection for 13-14 transaction type counters */
#define         EMI_BMID7               (( P_U32)(EMI_BASE+0x4CC))              /* EMI ID selection for 15-16 transaction type counters */
#define         EMI_BMID8               (( P_U32)(EMI_BASE+0x4D0))              /* EMI ID selection for 17-18 transaction type counters */
#define         EMI_BMID9               (( P_U32)(EMI_BASE+0x4D4))              /* EMI ID selection for 19-20 transaction type counters */
#define         EMI_BMID10              (( P_U32)(EMI_BASE+0x4D8))              /* EMI ID selection for 21 transaction type counters */
...
#define         EMI_BMRW0               (( P_U32)(EMI_BASE+0x4F8))              /* EMI read/write selection for 1-16 transaction type counters */
#define         EMI_BMRW1               (( P_U32)(EMI_BASE+0x4FC))              /* EMI read/write selection for 17-21 transaction type counters */
...
#define         DRAMC_DATLATCTL         (0x80)          /* DATLAT CONTROL REGISTER */
