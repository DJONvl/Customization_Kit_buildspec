...
//only core 0 power on and others cores are off after lastPC debug
#define WDT_DRAMC_CTL						TOPRGU_BASE+0x40

#define RG_MCU_CACHE_PRESERVE_EN_BIT				3
#define RG_MCU_CACHE_PRESERVE_EN_BIT_VAL			0
#define	DDR_RESERVE_MODE_BIT						7
#define	DDR_RESERVE_MODE_BIT_VAL					0
#define	RG_MCU_PWR_ISO_DIS_BIT						13
#define	RG_MCU_PWR_ISO_DIS_BIT_VAL					0
#define	RG_MCU_PWR_ON_BIT							12
#define	RG_MCU_PWR_ON_BIT_VAL						0
...
extern void md_power_down(void);
