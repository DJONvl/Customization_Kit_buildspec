...
/* RTC registers */
#define RTC_BBPU_MT6355			(RTC_BASE + 0x0002)
...
#define RTC_IRQ_STA_MT6355			(RTC_BASE + 0x0004)
#define RTC_IRQ_STA_AL			(1U << 0)
#define RTC_IRQ_STA_TC			(1U << 1)
#define RTC_IRQ_STA_LP			(1U << 3)

#define RTC_IRQ_EN_MT6355			(RTC_BASE + 0x0006)
...
#define RTC_CII_EN_MT6355			(RTC_BASE + 0x0008)
...
#define RTC_AL_MASK_MT6355			(RTC_BASE + 0x000A)
...
#define RTC_TC_SEC_MT6355			(RTC_BASE + 0x000C)
#define RTC_TC_SEC_MASK 0x003f

#define RTC_TC_MIN_MT6355			(RTC_BASE + 0x000E)
#define RTC_TC_MIN_MASK 0x003f

#define RTC_TC_HOU_MT6355			(RTC_BASE + 0x0000)
#define RTC_TC_HOU_MASK 0x001f

#define RTC_TC_DOM_MT6355			(RTC_BASE + 0x0012)
#define RTC_TC_DOM_MASK 0x001f

#define RTC_TC_DOW_MT6355			(RTC_BASE + 0x0014)
#define RTC_TC_DOW_MASK 0x0007

#define RTC_TC_MTH_MT6355			(RTC_BASE + 0x0016)
#define RTC_TC_MTH_MASK 0x000f

#define RTC_TC_YEA_MT6355			(RTC_BASE + 0x0018)
#define RTC_TC_YEA_MASK 0x007f

#define RTC_AL_SEC_MT6355			(RTC_BASE + 0x001A)
...
#define RTC_AL_MIN_MT6355			(RTC_BASE + 0x001C)
 ...
 */
#define RTC_AL_HOU_MT6355			(RTC_BASE + 0x001E)
 ...
 *              can't be overwrited.
 */
#define RTC_AL_DOM_MT6355			(RTC_BASE + 0x0010)
 ...
 */
#define RTC_AL_DOW_MT6355			(RTC_BASE + 0x0022)
...
#define RTC_EMBCK_SEL_DCXO_MT6355 		(0 << 6)	/*	0:dcxo_ck	1:eosc32_ck	2:emb_k_eosc_32	3: emb_hw	*/
#define RTC_EMBCK_SEL_EOSC_MT6355 		(1U << 6)
#define RTC_EMBCK_SEL_K_EOSC_MT6355	(2U << 6)
#define RTC_EMBCK_SEL_HW_MT6355 		(3U << 6)
...
#define RTC_POWERKEY1_MT6355			(RTC_BASE + 0x002A)
#define RTC_POWERKEY2_MT6355			(RTC_BASE + 0x002C)
 ...
 *     bit 15     : Debug bit
 */
#define RTC_PDN1_MT6355			(RTC_BASE + 0x002E)
 ...
 */
#define RTC_PDN2_MT6355			(RTC_BASE + 0x0020)
 ...
 */
#define RTC_SPAR0_MT6355			(RTC_BASE + 0x0032)
 ...
 */
#define RTC_SPAR1_MT6355			(RTC_BASE + 0x0034)
...
#define RTC_PROT_MT6355			(RTC_BASE + 0x0038)
#define RTC_PROT_UNLOCK1 		0x586a
#define RTC_PROT_UNLOCK2 		0x9136

#define RTC_DIFF_MT6355			(RTC_BASE + 0x003A)
...
#define RTC_CALI_MT6355			(RTC_BASE + 0x003C)
...
#define RTC_WRTGR_MT6355			(RTC_BASE + 0x003E)

#define RTC_CON_MT6355				(RTC_BASE + 0x0040)
