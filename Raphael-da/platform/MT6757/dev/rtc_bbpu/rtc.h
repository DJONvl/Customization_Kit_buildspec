...
*/
/* RTC registers */
#define RTC_BBPU_MT6351			(RTC_BASE + 0x0000)
...
#define RTC_IRQ_STA_MT6351			(RTC_BASE + 0x0002)
#define RTC_IRQ_STA_AL			(1U << 0)
#define RTC_IRQ_STA_TC			(1U << 1)
#define RTC_IRQ_STA_LP			(1U << 3)

#define RTC_IRQ_EN_MT6351			(RTC_BASE + 0x0004)
...
#define RTC_CII_EN_MT6351			(RTC_BASE + 0x0006)
...
#define RTC_AL_MASK_MT6351			(RTC_BASE + 0x0008)
...
#define RTC_TC_SEC_MT6351			(RTC_BASE + 0x000a)
#define RTC_TC_SEC_MASK 0x003f

#define RTC_TC_MIN_MT6351			(RTC_BASE + 0x000c)
#define RTC_TC_MIN_MASK 0x003f

#define RTC_TC_HOU_MT6351			(RTC_BASE + 0x000e)
#define RTC_TC_HOU_MASK 0x001f

#define RTC_TC_DOM_MT6351			(RTC_BASE + 0x0010)
#define RTC_TC_DOM_MASK 0x001f

#define RTC_TC_DOW_MT6351			(RTC_BASE + 0x0012)
#define RTC_TC_DOW_MASK 0x0007

#define RTC_TC_MTH_MT6351			(RTC_BASE + 0x0014)
#define RTC_TC_MTH_MASK 0x000f

#define RTC_TC_YEA_MT6351			(RTC_BASE + 0x0016)
#define RTC_TC_YEA_MASK 0x007f

#define RTC_AL_SEC_MT6351			(RTC_BASE + 0x0018)
...
#define RTC_AL_MIN_MT6351			(RTC_BASE + 0x001a)
 ...
 */
#define RTC_AL_HOU_MT6351			(RTC_BASE + 0x001c)
 ...
 */
#define RTC_AL_DOM_MT6351			(RTC_BASE + 0x001e)
 ...
 * 	   bit 8 ~ 15 : reserved bits
 */
#define RTC_AL_DOW_MT6351			(RTC_BASE + 0x0020)
 ...
 * 	   bit 8 ~ 15 : reserved bits
 */
#define RTC_AL_MTH_MT6351			(RTC_BASE + 0x0022)
#define RTC_NEW_SPARE3	0xff00
#define RTC_AL_MTH_MASK 0x000f

#define RTC_AL_YEA_MT6351			(RTC_BASE + 0x0024)
...
#define RTC_OSC32CON_MT6351			(RTC_BASE + 0x0026)
...
#define RTC_EMBCK_SEL_HW_MT6351 		(0 << 6)	/* 0: emb_hw	1: emb_k_eosc_32		2:dcxo_ck	3: eosc32_ck*/
#define RTC_EMBCK_SEL_K_EOSC_MT6351	 	(1U << 6)
//#define RTC_EMBCK_SEL_DCXO_MT6351 		(2U << 6)
#define RTC_EMBCK_SEL_EOSC_MT6351 		(3U << 6)
...
#define RTC_POWERKEY1_MT6351			(RTC_BASE + 0x0028)
#define RTC_POWERKEY2_MT6351			(RTC_BASE + 0x002a)
 ...
 *     bit 15     : Debug bit
 */
#define RTC_PDN1_MT6351			(RTC_BASE + 0x002c)
 ...
 */
#define RTC_PDN2_MT6351			(RTC_BASE + 0x002e)
 ...
 */
#define RTC_SPAR0_MT6351			(RTC_BASE + 0x0030)
 ...
 */
#define RTC_SPAR1_MT6351			(RTC_BASE + 0x0032)
...
#define RTC_PROT_MT6351			(RTC_BASE + 0x0036)
#define RTC_PROT_UNLOCK1 		0x586a
#define RTC_PROT_UNLOCK2 		0x9136

#define RTC_DIFF_MT6351			(RTC_BASE + 0x0038)
...
#define RTC_CALI_MT6351			(RTC_BASE + 0x003a)
...
#define RTC_WRTGR_MT6351			(RTC_BASE + 0x003c)

#define RTC_CON_MT6351				(RTC_BASE + 0x003e)
...
extern uint16 rtc_rdwr_uart_bits(uint16 *val);
...
extern void rtc_bbpu_power_on_mt6355(void);
extern void rtc_bbpu_power_down_mt6355(void);



#define RTC_DEFAULT_YEA 2000
