...
#define DRAM_CFG_ENABLE_DUMP        0xFFFFFFFF
...
*/
/****************this be moved to emi.c because not micro define PMIC_CHIP_MT6355 *************/
...
extern void dram_fatal_set_err(unsigned int err_code, unsigned int mask, unsigned int offset);
