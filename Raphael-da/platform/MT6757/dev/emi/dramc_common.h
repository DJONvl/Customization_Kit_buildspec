...
//  #define print LOGD 
    ...
    #define mcSHOW_ERR_MSG(_x_)  
    #else   // ETT real chip
    #define mcSHOW_DBG_MSG(_x_)   mcDELAY_US(100);opt_print _x_     
    #define mcSHOW_DBG_MSG2(_x_)  mcDELAY_US(100);opt_print _x_     
    #define mcSHOW_DBG_MSG3(_x_)  
    #define mcSHOW_DBG_MSG4(_x_)  
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_USER_MSG(_x_)  
...
#else  // preloader
    #if defined(TARGET_BUILD_VARIANT_ENG) && !CFG_TEE_SUPPORT
    ...
    #define mcSHOW_DBG_MSG5(_x_)	print _x_
...
extern struct regulator *reg_vdram1, *reg_vdram2, *reg_vcore; //Darren+
//#endif
