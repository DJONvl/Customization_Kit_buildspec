...
#define MSDC1_IO_PAD_BASE       (IOCFG_0_BASE)
#define MSDC2_IO_PAD_BASE       (IOCFG_4_BASE)

/*--------------------------------------------------------------------------*/
/* MSDC GPIO Related Register                                               */
/*--------------------------------------------------------------------------*/
#define MSDC0_GPIO_MODE23           (GPIO_BASE + 0x460)
#define MSDC0_GPIO_MODE24           (GPIO_BASE + 0x470)
#define MSDC1_GPIO_MODE4            (GPIO_BASE + 0x330)
#define MSDC1_GPIO_MODE5            (GPIO_BASE + 0x340)
#define MSDC2_GPIO_MODE17           (GPIO_BASE + 0x400)
#define MSDC2_GPIO_MODE18           (GPIO_BASE + 0x410)
...
#define MSDC1_GPIO_DRV_ADDR         (MSDC1_IO_PAD_BASE + 0xB0)
...
#define MSDC0_MODE_DAT6_MASK            (7 << 28)
#define MSDC0_MODE_DAT5_MASK            (7 << 24)
#define MSDC0_MODE_DAT1_MASK            (7 << 20)
#define MSDC0_MODE_CMD_MASK             (7 << 16)
#define MSDC0_MODE_CLK_MASK             (7 << 12)
#define MSDC0_MODE_DAT0_MASK            (7 << 8)

/* MSDC0_GPIO_MODE24, 001b is msdc mode */
#define MSDC0_MODE_DSL_MASK             (7 << 20)
#define MSDC0_MODE_DAT7_MASK            (7 << 16)
#define MSDC0_MODE_DAT3_MASK            (7 << 12)
#define MSDC0_MODE_DAT2_MASK            (7 << 8)
#define MSDC0_MODE_RSTB_MASK            (7 << 4)
#define MSDC0_MODE_DAT4_MASK            (7 << 0)
