...
#define DramcRankSwitchPerformanceEnhance_Tx_DVT
#if (defined(HW_GATING) && ENABLE_RX_TRACKING_LP4)
#define XRTR2R_PerformanceEnhance_DQSG_TRACK_RX_DLY_DVT
#endif
#define XRTR2W_PerformanceEnhance_RODTEN_DVT (!ENABLE_RODT_TRACKING)    //conflict with ENABLE_RODT_TRACKING, LP4 support only
...
#define PI_DUTY_IMPROVEMENT_TEST 0// Reserve bit for PI duty 
...
#undef DramcRankSwitchPerformanceEnhance_Tx_DVT
...
#if 0 //Pending, add DDR2400 freqGroup
...
typedef enum
{
    //--------LP3 normal mode (DBI_OFF) ----------------------------------
    AC_TIME_LP3_NORM_DDR1866_DBI_OFF = 0,
    AC_TIME_LP3_NORM_DDR1600_DBI_OFF,
    AC_TIME_LP3_NORM_DDR1333_DBI_OFF,
...
DRAM_STATUS_T DramcInit_PreSettings(DRAMC_CTX_T *p);
