...
#define MSDC0_IO_CFG                    IOCFG_TL_BASE

#define MSDC0_GPIO_MODE16       (GPIO_BASE + 0x3F0)
#define MSDC0_GPIO_MODE17       (GPIO_BASE + 0x400)

#define MSDC0_GPIO_IES_ADDR     (MSDC0_IO_CFG + 0x000)
#define MSDC0_GPIO_SMT_ADDR     (MSDC0_IO_CFG + 0x010)
#define MSDC0_GPIO_TDSEL_ADDR   (MSDC0_IO_CFG + 0x020)
#define MSDC0_GPIO_RDSEL_ADDR   (MSDC0_IO_CFG + 0x040)
#define MSDC0_GPIO_PULLEN_ADDR  (MSDC0_IO_CFG + 0x060)
#define MSDC0_GPIO_PULLSEL_ADDR (MSDC0_IO_CFG + 0x080)
#define MSDC0_GPIO_DRV_ADDR     (MSDC0_IO_CFG + 0x0A0)
#define MSDC0_GPIO_PUPD0_ADDR   (MSDC0_IO_CFG + 0x0C0)
#define MSDC0_GPIO_PUPD1_ADDR   (MSDC0_IO_CFG + 0x0D0)

#define MSDC0_DRV_RSTB_MASK     (0x7 << 16)
#define MSDC0_DRV_DSL_MASK      (0x7 << 12)
#define MSDC0_DRV_CLK_MASK      (0x7 << 8)
#define MSDC0_DRV_DAT_MASK      (0x7 << 4)
#define MSDC0_DRV_CMD_MASK      (0x7 << 0)

#define GPIO_HW_TRAPPING        (GPIO_BASE+0x06E0)
#define TRAP_EMMC_DATAPIN       (0x3 << 25)  // [26:25]
