...
/*WDT*/
#define MTK_WDT_BASE				(TOPRGU_BASE) 							//Sheet InfrasysAPB_AO, line 10, RGU includes WDT

#define WDT_MODE				((volatile uint16 *)(MTK_WDT_BASE + 0x0000))
#define WDT_LENGTH				((volatile uint16 *)(MTK_WDT_BASE + 0x0004))
#define WDT_RESTART				((volatile uint16 *)(MTK_WDT_BASE + 0x0008))
#define WDT_SWRST               ((volatile uint16 *)(MTK_WDT_BASE + 0x0014))
...
#define MTK_RG_DFD_COUNT_EN         (0x00080)
#define MTK_RG_DRAMC_RD_TEST_EN     (1<<11)
#define MTK_RG_DRAMC_RDWT_TEST_EN   (1<<12)
#define MTK_RG_DFD_TIMEOUT_MASK     (0x7FF<<13)
...
extern void mtk_wdt_init(void); // chandler  add
