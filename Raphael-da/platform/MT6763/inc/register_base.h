...
// APB Module cksys
#define CKSYS_BASE (0x10000000)//not found
#define TOPCKGEN_BASE (0x10000000)

// APB Module infracfg_ao
#define INFRACFG_AO_BASE (0x10001000)
#define IOCFG_0_BASE (0x10002000)			// not used
...
// APB Module dramc
#define DRAMC0_BASE (0x10004000) //dram initialize//not found
...
// APB Module ddrphy
#define DDRPHY_BASE (0x1000F000)//not found

// APB Module kp
#define KP_BASE (0x10010000)

// APB Module md32
#define MD32_BASE (0x10058000)//not found

// APB Module dbgapb
#define DBGAPB_BASE (0x10100000)//not found

// APB Module mcucfg
#define MCUCFG_BASE (0x0C530000)

// APB Module ca7mcucfg
#define CA7MCUCFG_BASE (0x10200000)//not found
...
#define DRAMC_NAO_BASE (0x1020E000)//not found

// APB Module trng
#define TRNG_BASE (0x1020F000)

// APB Module gcpu
#define GCPU_BASE (0x10210000)//delete on memory map
...
// APB Module cq_dma
#define CQ_DMA_BASE (0x10212c00) //dram use//not found
...
// APB Module usb2
#define USB_BASE (0x11200000)		//not found

// APB Module usb_sif
#define USBSIF_BASE (0x11F40000)//not found
...
#define MSDC_TOP_BASE (0x11F50000)
...
#define GIC_CPU_BASE  (0x0C400000)
