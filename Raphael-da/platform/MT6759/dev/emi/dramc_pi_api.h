...
#define fcWhitney       6
#define fcAlaska        7
#define fcFOR_CHIP_ID   fcAlaska

#define VENDOR_HYNIX 6



#define CHANNEL_NUMBER      2   // 1 single channek, 2 dual channel, 4 4 channel
...
#define ENABLE_SW_RUN_TIME_ZQ_WA 0 //sagy
...
#define CHANNEL_NUMBER 2 //work only for Olympus LP4, LP3 is only single channel
...
#define APPLY_LOWPOWER_GOLDEN_SETTINGS 0 //sagy
...
{
    U16 u2MR5VendorID;
    U64 u4MR8Density[CHANNEL_MAX][RANK_MAX];
} DRAM_INFO_BY_MRR_T;
#endif
