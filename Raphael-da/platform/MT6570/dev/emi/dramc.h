...
#define PHYSYNC_MODE // for D-3, Rainier
...
#define DDRPHY_WRITE_REG(val,offset)    DRV_WriteReg32(val, (DDRPHY_BASE + (offset)))
#define DRAMC0_WRITE_REG(val,offset)    DRV_WriteReg32(val, (DRAMC0_BASE + (offset)))
#define DRAMC_NAO_WRITE_REG(val,offset) DRV_WriteReg32(val, (DRAMC_NAO_BASE + (offset)))
#define MCUSYS_CFGREG_WRITE_REG(val,offset) DRV_WriteReg32(val, (MCUSYS_CFGREG_BASE + (offset)))
