...
#define RTC_CALI_BBPU_2SEC_SHIFT		9
#define RTC_CALI_BBPU_2SEC_MODE			(3U << RTC_CALI_BBPU_2SEC_SHIFT)
...
#define RG_FQMTR_EN			MT6350_FQMTR_CON0
#define RG_FQMTR_TCKSEL		MT6350_FQMTR_CON0
#define RG_FQMTR_WINSET		MT6350_FQMTR_CON1
#define RG_FQMTR_BUSY			MT6350_FQMTR_CON0
#define RG_FQMTR_DATA			MT6350_FQMTR_CON2

#define RG_FQMTR_TCKSEL_MASK		0x7
#define RG_FQMTR_TCKSEL_SHIFT		0x0
#define RG_FQMTR_26M_EN_MASK		0x1
#define RG_FQMTR_26M_EN_SHIFT		0x2
#define RG_FQMTR_CKSEL_SHIFT            0x6
...
#define RTC_REG_XOSC32_ENB		(1U << 13)
#define RTC_GP_OSC32_CON		(3U << 14)
#define RTC_EOSC32_CHOP_EN 	(1U << 10)
...
*/
#define RTC_EOSC32_OPT			(1U << 8)	
#define RTC_EMBCK_SEL_OPTION	(1U << 11)
#define RTC_EMBCK_SRC_SEL		(1U << 7)
...
#define RTC_REG_XOSC32_ENB_SHIFT	13
