...
*/
#define IO_CONFIG_BOTTOM_base               (0x10015000)

#define REG1_ADDR(x)        ((volatile u32*)(GPIO_BASE + x))
#define REG2_ADDR(x)        ((volatile u32*)(IO_CONFIG_BOTTOM_base + x))

#define MSDC_GPIO_MODE5             REG1_ADDR(0x00B0)
#define MSDC_GPIO_MODE6             REG1_ADDR(0x00C0)

#define MSDC0_PULL_SEL_CFG_BASE     REG2_ADDR(0x18)
#define MSDC0_PULL_R0_CFG_BASE      REG2_ADDR(0x24)
#define MSDC0_PULL_R1_CFG_BASE      REG2_ADDR(0x30)
...
#define MSDC0_RDSEL_BASE            REG2_ADDR(0x84)
#define MSDC0_TDSEL_BASE            REG2_ADDR(0x90)
#define MSDC0_SELGP_CLR             REG2_ADDR(0xB0)

#define MSDC_PAD_CTRL_SMT_CFG       REG2_ADDR(0x54)
#define MSDC_PAD_SMT_CTRL_MASK      0x1FFC00

#define MSDC0_DRVING0_BASE          REG2_ADDR(0x6C)
...
#define MSDC0_DRVING1_BASE          REG2_ADDR(0x78)
