...
extern int blkdev_bread_part(blkdev_t *bdev, u32 blknr, u32 blks, u8 *buf, emmc_section_e part);
extern int blkdev_bwrite_part(blkdev_t *bdev, u32 blknr, u32 blks, u8 *buf, emmc_section_e part);
extern int blkdev_read_part(blkdev_t *bdev, u64 src, u64 size, u8 *dst, emmc_section_e part);
extern int blkdev_write_part(blkdev_t *bdev, u64 dst, u64 size, u8 *src, emmc_section_e part);
#endif
