...
FEATURE_SWITCHES_INIT.ENABLE_EMMC_DMA	:=0
FEATURE_SWITCHES_LOOP.ENABLE_EMMC_DMA	:=1

FEATURE_SWITCHES_INIT.ENABLE_USB_DMA	:=0
FEATURE_SWITCHES_LOOP.ENABLE_USB_DMA  :=1

FEATURES.ENABLE_MSDC_DMA 	:= 0
FEATURES.ENABLE_USB_DMA		:= 1
