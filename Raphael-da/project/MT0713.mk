...
#first da address: L2 cache, use 512K
ADDRS.DA_INIT_BASE_ADDRESS 	   	:= 0x200000
ADDRS.DA_INIT_SIZE		 	   	:= 0x80000

#second da address 128K -4K
ADDRS.DA_INIT_HEAP_BASE_ADDRESS  	:= 0x110000
ADDRS.DA_INIT_HEAP_BASE_SIZE	   	:= 0x1F000
