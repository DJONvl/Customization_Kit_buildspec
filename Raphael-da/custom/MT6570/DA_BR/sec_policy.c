...
struct policy_part_map g_policy_map[] = {
	...
	{PL_SW_ID,          "preloader",   "PRELOADER", 0, 0, PL_SEC_POLICY_1, PL_SEC_POLICY_2, PL_SEC_POLICY_3, PL_SEC_POLICY_4, PL_BINDING_HASH},
	{LK_SW_ID,          "lk",          "UBOOT", 0, 0, LK_SEC_POLICY_1, LK_SEC_POLICY_2, LK_SEC_POLICY_3, LK_SEC_POLICY_4, LK_BINDING_HASH},
	{LOGO_SW_ID,        "logo",        "LOGO", 0, 0, LOGO_SEC_POLICY_1, LOGO_SEC_POLICY_2, LOGO_SEC_POLICY_3, LOGO_SEC_POLICY_4, LOGO_BINDING_HASH},
	{BOOT_SW_ID,        "boot",        "BOOTIMG", 0, 0, BOOT_SEC_POLICY_1, BOOT_SEC_POLICY_2, BOOT_SEC_POLICY_3, BOOT_SEC_POLICY_4, BOOT_BINDING_HASH},
	{SYSTEM_SW_ID,      "system",      "ANDROID", 0, 0, SYSTEM_SEC_POLICY_1, SYSTEM_SEC_POLICY_2, SYSTEM_SEC_POLICY_3, SYSTEM_SEC_POLICY_4, SYSTEM_BINDING_HASH},
	...
	{CACHE_SW_ID,       "cache",       0, 0, 0, CACHE_SEC_POLICY_1, CACHE_SEC_POLICY_2, CACHE_SEC_POLICY_3, CACHE_SEC_POLICY_4, CACHE_BINDING_HASH},	
	{SECRO_SW_ID,       "secro",       "SEC_RO", 0, 0, SECRO_SEC_POLICY_1, SECRO_SEC_POLICY_2, SECRO_SEC_POLICY_3, SECRO_SEC_POLICY_4, SECRO_BINDING_HASH},	
	...
	{USERDATA_SW_ID,    "userdata",    "USRDATA", 0, 0, USERDATA_SEC_POLICY_1, USERDATA_SEC_POLICY_2, USERDATA_SEC_POLICY_3, USERDATA_SEC_POLICY_4, USERDATA_BINDING_HASH},
	{MD1IMG_SW_ID,      "md1img",      "MD1IMG", 0, 0, MD1IMG_SEC_POLICY_1, MD1IMG_SEC_POLICY_2, MD1IMG_SEC_POLICY_3, MD1IMG_SEC_POLICY_4, MD1IMG_BINDING_HASH},
    ...
    {SGPT_SW_ID,        "sgpt",   "SGPT", "MIRROR_PMT", 0, SGPT_SEC_POLICY_1, SGPT_SEC_POLICY_2, SGPT_SEC_POLICY_3, SGPT_SEC_POLICY_4, SGPT_BINDING_HASH},
    {PGPT_SW_ID,        "pgpt",   "PGPT", "MAIN_PMT", 0, PGPT_SEC_POLICY_1, PGPT_SEC_POLICY_2, PGPT_SEC_POLICY_3, PGPT_SEC_POLICY_4, PGPT_BINDING_HASH},
	{EFUSE_SW_ID,        "efuse",   0, 0, 0, EFUSE_SEC_POLICY_1, EFUSE_SEC_POLICY_2, EFUSE_SEC_POLICY_3, EFUSE_SEC_POLICY_4, EFUSE_BINDING_HASH},   
	/*Custom img*/
