...
NAND_MLC_FEATURE g_MICRON_MLC_FEATURE =
{1,1,2,2,2, 0xEF,0xEE,7,0,0x89,0xFF,0x01,0x05,0x14, RTYPE_MICRON,
{{{0,6},{1,7},{2,0xffff},{3,0xffff},{4,10},{5,11},
{8,14},{9,15},{12,18},{13,19},{16,22},{17,23},
{20,26},{21,27},{24,30},{25,31},{28,34},{29,35},
{32,38},{33,39},{36,42},{37,43},{40,46},{41,47},
...
const NAND_Device_S g_NandFlashDevTbl_Internal[] = {
	...
	/* Micron MLC */
	,{ NAND_MT29F64G08CBABB,   { { 0x2C, 0x64, 0x44, 0x4B, 0xA9, 0xFF},   8192/*MB*/, 256, 8192, NAND_IO_8BITS, 5, 80,0 , 1024, 1}, NAND_FLASH_AMLC, &g_MICRON_MLCTLC_FEATURE, &g_NAND_SAMSUNG_2048_CMD_SET, &g_MICRON_MLC_FEATURE}
