...
extern status_t get_sboot_state(u32 *sboot);
...
struct policy_part_map g_policy_map[] = {
   ...
   {PGPT_SW_ID,        "pgpt",   "PGPT", 0, 0, PGPT_SEC_POLICY_1, PGPT_SEC_POLICY_2, PGPT_SEC_POLICY_3, PGPT_SEC_POLICY_4, PGPT_BINDING_HASH},   
    {CAM_VPU1_SW_ID,    "cam_vpu1",    0, 0, 0, CAM_VPU1_SEC_POLICY_1, CAM_VPU1_SEC_POLICY_2, CAM_VPU1_SEC_POLICY_3, CAM_VPU1_SEC_POLICY_4, CAM_VPU1_BINDING_HASH},
    {CAM_VPU2_SW_ID,    "cam_vpu2",    0, 0, 0, CAM_VPU2_SEC_POLICY_1, CAM_VPU2_SEC_POLICY_2, CAM_VPU2_SEC_POLICY_3, CAM_VPU3_SEC_POLICY_4, CAM_VPU3_BINDING_HASH},
    {CAM_VPU3_SW_ID,    "cam_vpu3",    0, 0, 0, CAM_VPU3_SEC_POLICY_1, CAM_VPU3_SEC_POLICY_2, CAM_VPU3_SEC_POLICY_3, CAM_VPU3_SEC_POLICY_4, CAM_VPU3_BINDING_HASH},
...
static unsigned int get_sec_state(unsigned int *sboot_state, unsigned int *lock_state)
{
   ...
   LOGD("[SEC_POLICY] sboot_state = 0x%x\n", *sboot_state);
   if (!default_lock_state)
      LOGD("[SEC_POLICY] lock_state = 0x%x\n", *lock_state);
   else
      LOGD("[SEC_POLICY] lock_state(default) = 0x%x\n", *lock_state);
