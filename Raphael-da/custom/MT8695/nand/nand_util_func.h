...
#define NUTL_DEVICE_AMLC()                                     ((g_pNandInfo->m_dev->m_mlc_setting) && (g_pNandInfo->m_dev->m_nand_type == NAND_FLASH_AMLC))
...
#define NUTL_SET_FEATURE()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->set_feature: 0xFF)
#define NUTL_GET_FEATURE()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->get_feature: 0xFF)
...
#define NUTL_READ_RETRY_TYPE()					                (g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->read_retry_type: 0xFF)
#define NUTL_SYNC_ACCCON()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->acccon: 0xFFFFFFFF)
#define NUTL_SYNC_ACCCON1()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->acccon1: 0xFFFFFFFF)
#define NUTL_SYNC_ADDR()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->interface_address: 0xFF)
#define NUTL_SYNC_VALUE()						(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->interface_sync: 0xFF)
#define NUTL_DLY_MUX()							(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->dqs_mux: 0xFF)
#define NUTL_DLY_CTRL()							(g_pNandInfo->m_dev->m_mlc_setting != NULL?g_pNandInfo->m_dev->m_mlc_setting->dqs_ctrl: 0xFF)
...
#define NUTL_2P_TLC()								(g_pNandInfo->m_dev->m_tlc_setting != NULL?g_pNandInfo->m_dev->m_hw_info.two_plane:FALSE)
...
// Read ID
//------------------------------------------------------------------------------
//status_t  NUTL_ReadID(const uint32 c_timeout, uint32 * id1, uint32 * id2);
...
//extern void NUTL_FLUSH_BMT(CALLBACK_BMPCHECK_PROGRESS prog_update);
//------------------------------------------------------------------------------
...
/********************************************************************************/
#if 0
extern status_t NUTL_OTP_CheckDevice(void);
...
extern status_t NUTL_OTP_Page_Read(const uint32 otp_offset, uint32  * p_page);
extern status_t NUTL_OTP_Page_Program(const uint32 otp_offset, uint32 * p_page);
extern status_t NUTL_OTP_Program_CheckDone(void);
extern status_t NUTL_OTP_Lock(void);
extern status_t NUTL_OTP_Lock_CheckStatus(void);
#endif
status_t NUTL_Get_DL_INFO_Addr(uint32 *addr);
