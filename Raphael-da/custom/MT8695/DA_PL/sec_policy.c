...
struct policy_part_map g_policy_map[] = {
   ...
   {TEE1_SW_ID,        "tee1",        "TEE1", 0, 0, TEE1_SEC_POLICY_1, TEE1_SEC_POLICY_2, TEE1_SEC_POLICY_3, TEE1_SEC_POLICY_4, TEE1_BINDING_HASH},
   {TEE2_SW_ID,        "tee2",        "TEE2", 0, 0, TEE2_SEC_POLICY_1, TEE2_SEC_POLICY_2, TEE2_SEC_POLICY_3, TEE2_SEC_POLICY_4, TEE2_BINDING_HASH},	
	 {CACHE_SW_ID,       "cache",       0, 0, 0, CACHE_SEC_POLICY_1, CACHE_SEC_POLICY_2, CACHE_SEC_POLICY_3, CACHE_SEC_POLICY_4, CACHE_BINDING_HASH},	
	 {SECRO_SW_ID,       "secro",       0, 0, 0, SECRO_SEC_POLICY_1, SECRO_SEC_POLICY_2, SECRO_SEC_POLICY_3, SECRO_SEC_POLICY_4, SECRO_BINDING_HASH},	
   ...
   {SGPT_SW_ID,        "sgpt",   "SGPT", 0, 0, SGPT_SEC_POLICY_1, SGPT_SEC_POLICY_2, SGPT_SEC_POLICY_3, SGPT_SEC_POLICY_4, SGPT_BINDING_HASH},
   {PGPT_SW_ID,        "pgpt",   "PGPT", 0, 0, PGPT_SEC_POLICY_1, PGPT_SEC_POLICY_2, PGPT_SEC_POLICY_3, PGPT_SEC_POLICY_4, PGPT_BINDING_HASH},   
...
unsigned char *get_binding_hash(unsigned int policy_entry_idx)
{
   ...
   return (unsigned char *)&g_binding_hash;
}
