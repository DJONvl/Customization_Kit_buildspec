...
#define ECC_ENCIRQEN    		((volatile uint32*)(ECC_base+0x0080))
#define ECC_ENCIRQSTA   		((volatile uint32*)(ECC_base+0x0084))
#define ECC_PIO_DIRDY   		((volatile uint32*)(ECC_base+0x0090))
#define ECC_PIO_DI      		((volatile uint32*)(ECC_base+0x0094))
#define ECC_DECCON      		((volatile uint32*)(ECC_base+0x0100))
...
#define ECC_DECIRQEN    		((volatile uint32*)(ECC_base+0x0200))
#define ECC_DECIRQSTA   		((volatile uint32*)(ECC_base+0x0204))
#define ECC_DECFSM 				((volatile uint32*)(ECC_base+0x0208))
#define ECC_BYPASS 				((volatile uint32*)(ECC_base+0x020C))

#define ECC_ENCPAR0     		((volatile uint32*)(ECC_base+0x0300))
#define ECC_ENCPAR1     		((volatile uint32*)(ECC_base+0x0304))
#define ECC_ENCPAR34 			((volatile uint32*)(ECC_base+0x0388))

#define ECC_DECEL0      		((volatile uint32*)(ECC_base+0x0500))
#define ECC_DECEL1      		((volatile uint32*)(ECC_base+0x0504))
#define ECC_DECEL39				((volatile uint32*)(ECC_base+0x059C))
